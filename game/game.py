...
class Game:
    ...
    def draw_text(self):
        self.display_text(self.score_format(),36,GREEN,WIDTH//2,TEXT_POSY)         
        self.display_text(self.level_format(),36,GREEN,60,TEXT_POSY)         
        
        if not self.playing:
            self.display_text('Perdiste',60,GREEN,WIDTH//2,HEIGHT//2)
            self.display_text('Presiona R para comenzar de nuevo',30,GREEN,WIDTH//2,50)
    ...
    def menu(self):
        ...
        self.display_text('Presiona una tecla para empezar',36,BLACK,WIDTH//2,10)
